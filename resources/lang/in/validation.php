...
return [
    ...
    */
    ...
    'gt' => [
        'numeric' => 'Isian :attribute seharusnya lebih besar dari :value.',
        'file' => 'Isian :attribute seharusnya lebih besar dari :value kilobyte.',
        'string' => 'Isian :attribute seharusnya lebih besar dari :value karakter.',
        'array' => 'Isian :attribute seharusnya memiliki lebih dari :value item.',
    ],
    'gte' => [
        'numeric' => 'Isian :attribute seharusnya lebih besar atau sama :value.',
        'file' => 'Isian :attribute seharusnya lebih besar atau sama :value kilobyte.',
        'string' => 'Isian :attribute seharusnya lebih besar atau sama :value karakter.',
        'array' => 'Isian :attribute seharusnya memiliki :value item atau lebih.',
    ],
    ...
    'lt' => [
        'numeric' => 'The :attribute seharusnya kurang dari :value.',
        'file' => 'The :attribute seharusnya kurang dari :value kilobyte.',
        'string' => 'The :attribute seharusnya kurang dari :value karakter.',
        'array' => 'The :attribute seharusnya memiliki kurang dari :value item.',
    ],
    'lte' => [
        'numeric' => 'Isian :attribute seharusnya kurang dari atau sama :value.',
        'file' => 'Isian :attribute seharusnya kurang dari atau sama :value kilobyte.',
        'string' => 'Isian :attribute seharusnya kurang dari atau sama :value karakter.',
        'array' => 'Isian :attribute seharusnya tidak memiliki lebih dari :value item.',
    ],
    'max' => [
    ...
    'starts_with' => 'Isian :attribute seharusnya memulai dengan salah satu dari beikut ini :values.',
